...
export default function ReportAnonymous() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setLoadingText('Saving anonymous report...');
      // Insert incident without user_id
      ...
      if (insertError) {
        ...
        setError(`Submission failed: ${insertError.message} - Please ensure your Supabase database schema allows anonymous inserts.`);
        setLoading(false);
        return;
      }
  ...
  if (success) {
    return (
      <div className="p-6 lg:p-8 flex flex-col items-center justify-center min-h-[80vh] relative">
        <div className="scanline-overlay" />
        <div className="cyber-card cyber-frame p-10 text-center relative z-10 max-w-md">
          ...
          <h2 className="text-2xl font-display font-bold text-white mb-4 tracking-wider">REPORT SUBMITTED</h2>
          <p className="text-slate-400 font-mono text-sm mb-8 leading-relaxed">
            Your incident has been securely and anonymously submitted to our investigation team. 
            Thank you for helping keep cyberspace safe.
          </p>
          <button
            onClick={() => navigate('/')}
    ...
    <div className="min-h-screen bg-dark-950 pt-24 pb-12">
      <div className="p-6 lg:p-8 max-w-4xl mx-auto relative">
        ...
        <div className="mb-8 relative z-10">
          ...
          <p className="text-slate-400 font-mono text-sm">Provide details about the cyber incident. Your identity will remain unknown.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-8 relative z-10">
          ...
          <div className="cyber-card cyber-frame p-6">
            ...
            <input
              ...
              placeholder="e.g. +91 9876543210 (Optional - if you want us to contact you)"
              className="cyber-input w-full"
            />
          </div>
